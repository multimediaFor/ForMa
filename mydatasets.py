...
class MyDataset(Dataset):
    def __init__(self, num=0, file='', choice='train',input_size=512,gt_ratio=1):
        self.num = num
        self.choice = choice
        self.filelist = file
...
#
# train_file_tmp = np.load("../flist/Columbia_160.npy")
# train_num = len(train_file_tmp)
# train_dataset=MyDataset(num=train_num, file=train_file_tmp, choice='train',input_size=512,num_classes=2)
